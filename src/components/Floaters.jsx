...
export default function Floaters() {
  return (
    <div className="floaters">
      <a
        href={`https://wa.me/${WHATSAPP}?text=Hi%20CodeNest%20Dev%2C%20I%20need%20a%20website!`}
        target="_blank" rel="noreferrer"
        title="Chat on WhatsApp"
      >
        <button className="floater floater-wa" aria-label="WhatsApp">
      ...
      <a href={INSTAGRAM} target="_blank" rel="noreferrer" title="Instagram">
        <button className="floater floater-ig" aria-label="Instagram">
